...
const ownervb = process.env.OWNERS || process.env.OWNER_NUMBER || '94727680749' ; // put your number here
...
//
global.botname = process.env.BOTNAME || 'QUEEN-SADU-AI';
global.pairingNumber = process.env.BOT_NUMBER || '94788001464' ;  // put your number here
global.SESSION_ID = process.env.SESSION_ID || 'iIYEya5T#02WQz47IiZdbMM2iGJmfLo_kKSzEKer8I6IH0aU4AEs' ;  // put your session id here
